...
\ifx\homepath\overleafhome
    ...
    \input{Chapters/0_introduction.tex} %\newpage
  	...
  	\input{Chapters/2_cost_model.tex} %\newpage
  	\input{Chapters/3_results.tex} %\newpage
  	\input{Chapters/4_sensitivity_analysis.tex} %\newpage
...
\else
    ...
    \input{latex/Chapters/0_introduction.tex} %\newpage
  	...
  	\input{latex/Chapters/2_cost_model.tex} %\newpage
  	\input{latex/Chapters/3_results.tex} %\newpage
  	\input{latex/Chapters/4_sensitivity_analysis.tex} %\newpage
  	\input{latex/Chapters/5_discussion.tex} %\newpage
  	\input{latex/Chapters/6_conclusion.tex} %\newpage
\fi
